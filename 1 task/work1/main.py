...
# l.insert (1,56) # добавление элемента с указаным индексом (индекс, добавляет элемент)
# l.remove () # удаляет указанный элемент один раз
# l.pop() # удаляет элемент с указанным индексом, если ни чего не указывать удалит последний
